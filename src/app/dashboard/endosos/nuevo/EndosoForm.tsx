  ...
  return (
    <form action={initialData ? updateEndoso.bind(null, initialData.id) : createEndoso} className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="border border-gray-300 shadow-sm bg-white">
        ...
        {/* SECCIÓN DE FIRMA */}
        <div className="md:col-span-2 mt-4 p-4 border border-gray-300 bg-gray-50 rounded space-y-4">
          <h3 className="font-bold text-[#2e5e2e]">DATOS DEL FIRMANTE (PARA LA CARTA)</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[1px] bg-gray-300 border border-[#1b3d1b]">
            <div className="bg-white grid grid-cols-1 md:grid-cols-3">
              ...
              <div className="md:col-span-2">
                <input 
                  type="text" 
                  name="firmanteNombre" 
                  defaultValue={initialData?.firmanteNombre ?? 'Shirley Torres Reyes'} 
                  placeholder="Ej. Shirley Torres Reyes" 
                  className="w-full h-full min-h-[36px] bg-[#fff599] border-none px-3 py-2 text-sm focus:ring-0 focus:outline-none" 
                />
              </div>
            </div>
            ...
            <div className="bg-white grid grid-cols-1 md:grid-cols-3">
              ...
              <div className="md:col-span-2">
                <input 
                  type="text" 
                  name="firmantePuesto" 
                  defaultValue={initialData?.firmantePuesto ?? 'Ayudante Especial'} 
                  placeholder="Ej. Ayudante Especial" 
                  className="w-full h-full min-h-[36px] bg-[#fff599] border-none px-3 py-2 text-sm focus:ring-0 focus:outline-none" 
                />
              </div>
            </div>
            ...
            <div className="bg-white grid grid-cols-1 md:grid-cols-3">
              <div className="bg-[#2e5e2e] text-white p-3 font-bold text-sm flex items-center border-r border-[#1b3d1b]">
                EXTENSIÓN TELEFÓNICA
              </div>
              <div className="md:col-span-2">
                <input 
                  type="text" 
                  name="firmanteExtension" 
                  defaultValue={initialData?.firmanteExtension ?? '2133'} 
                  placeholder="Ej. 2133" 
                  className="w-full h-full min-h-[36px] bg-[#fff599] border-none px-3 py-2 text-sm focus:ring-0 focus:outline-none" 
                />
              </div>
            ...
            <div className="bg-white grid grid-cols-1 md:grid-cols-3">
              ...
              <div className="md:col-span-2">
                <input 
                  type="email" 
                  name="firmanteEmail" 
                  defaultValue={initialData?.firmanteEmail ?? 'storres@toabaja.com'} 
                  placeholder="Ej. storres@toabaja.com" 
                  className="w-full h-full min-h-[36px] bg-[#fff599] border-none px-3 py-2 text-sm focus:ring-0 focus:outline-none" 
                />
              </div>
            </div>
