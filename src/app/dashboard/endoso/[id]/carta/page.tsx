...
export default async function CartaEndoso({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="container" style={{ backgroundColor: '#fff', minHeight: '100vh', padding: '0', maxWidth: '850px', margin: '0 auto', color: '#000' }}>
      ...
      <div style={{ padding: '20px 0 10px', display: 'flex', justifyContent: 'flex-end' }} className="no-print">
        <PrintButton />
      </div>

      <div className="printable-document" style={{ padding: '40px 60px', position: 'relative', fontSize: '10.5pt', fontFamily: '"Times New Roman", Times, serif', lineHeight: '1.45', minHeight: '1050px', display: 'flex', flexDirection: 'column' }}>
