    ...
    <div className="min-h-screen bg-[#2e5e2e] flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-sm w-full text-center overflow-hidden relative">
        ...
        <div className="relative z-10">
          ...
          <ReciboViewer
            reciboPatenteUrl={endoso.reciboPatenteUrl}
            reciboPatente={endoso.reciboPatente}
            reciboAmbulanteUrl={endoso.reciboAmbulanteUrl}
            reciboAmbulante={endoso.reciboAmbulante}
            reciboBebidasUrl={endoso.reciboBebidasUrl}
            reciboBebidas={endoso.reciboBebidas}
